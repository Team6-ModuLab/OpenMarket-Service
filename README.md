...
10. [아키텍처 설계](#아키텍처-설계)
11. [주요 기능](#주요-기능)
12. [사용자 시나리오](#사용자-시나리오)
13. [화면 설계 (IA/화면 흐름)](#화면-설계-ia화면-흐름)
14. [시연 영상](#시연-영상)
15. [API / 인증 흐름](#api--인증-흐름)
16. [모듈별 책임](#모듈별-책임)
...
| 강민기 | 32 | `pages/seller/`, `pages/auth/login/`, `pages/mypage/` | 로그인, 판매자 센터, 상품 등록/수정, 마이페이지, 주문결제 기능 담당 |
